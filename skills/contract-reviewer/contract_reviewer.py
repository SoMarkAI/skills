...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="SoMark 合同解析工具：将合同文件转换为结构化内容以供风险审查")
    parser.add_argument("-f", "--file", required=True, type=str, help="合同文件路径")
    parser.add_argument("-o", "--output", type=str, default="./contract_reviewer_output", help="输出目录（默认：./contract_reviewer_output）")
