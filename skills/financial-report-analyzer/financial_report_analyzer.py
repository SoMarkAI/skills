...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="SoMark 财报分析工具：解析财务报告并提取关键指标与风险信号")
    parser.add_argument("-f", "--file", required=True, type=str, help="财报文件路径")
    parser.add_argument("-o", "--output", type=str, default="./financial_report_output", help="输出目录（默认：./financial_report_output）")
